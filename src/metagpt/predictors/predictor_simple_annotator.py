...
class PredictorSimpleAnnotation(PredictorTemplate):
    ...
    class XMLAnnotationFunction(BaseModel):
        ...
        annotations: Optional[dict] = Field(
            None, 
            description="The structured annotations dictionary, with the metadatawhich is to be added to the OME XML. The dictionary shouldnt contain meta keys such as MetaData which are not explicitly in the raw metadat.")
