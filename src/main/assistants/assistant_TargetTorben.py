...
class TargetTorben(AssistantTemplate):
    ...
    def __init__(self, ome_xsd_path, client):
        ...
        self.pre_prompt = (f"You are {self.name}, a specialized AI assistant within a collective known as the"
                           ...
                           "Role and Task:\n"
                           f"As {self.name}, your expertise lies in understanding metadata and ontologies and mapping"
                           f"the two together. Your task involves:\n"
                           "Receiving Inputs:\n"
                           ...
                           "metadata clear"
                           "by adding the metadata as sub-nodes to the 'Missing_Target' element node"
                           "(inside the unstructured annotations).\n"
