...
class MissingMyrte(AssistantTemplate):
    ...
    def __init__(self, ome_xsd_path, client):
        ...
        self.pre_prompt = (f"You are {self.name}, a specialized AI assistant within a collective known as the"
                           ...
                           "metadata input). Ther first list should contain the to be mapped metadata and the second"
                           "the one without possible maps (lets call it missing target). Seperate the two by"
                           "'\n - - - \n’ \n"
                           "Objective:\n"
