...
class MappingMargarete(AssistantTemplate):
    ...
    def __init__(self, ome_xsd_path, client):
        ...
        self.pre_prompt = (f"You are {self.name}, a specialized AI assistant within a collective known as the"
                           ...
                           "Role and Task:\n"
                           "Your expertise lies in mapping raw metadata to the OME XML schema. Your task involves:\n"
                           "Receiving Inputs:\n"
                           ...
                           "pairs."
                           "The data was previously filtered by fellow assistants and should only contain metadata that"
