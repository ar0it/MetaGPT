...
class XMLPredictor:
    ...
    def __init__(self,
        ...
        """
        self.xml_schema_path = ome_xsd_path
    ...
    def predict(self):
        ...
        with open("../main/assistant_id.txt", "r") as f:
    ...
    def init_assistant(self):
        ...
        with open("../main/assistant_id.txt", "w") as f:
    ...
    def run_message(self):
        ...
        if validation is not None:
            ...
            msg = "There seems to be an issue with the OME XML you provided. Please fix this error: " + str(validation)
